...
void test_subscriber_latency(const char* test_name) {
    ...
    std::cout << "Subscriber A started to deal with " << test_name << std::endl;
    int ctr = 0;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "SubscriberA started." << std::endl;
    ...
    // ./sample_subscriberA 1K  # 测试 1KB 消息
    // ./sample_subscriberA 1M  # 测试 1MB 消息
    // ./sample_subscriberA 10M # 测试 10MB 消息
    // ./sample_subscriberA 20M # 测试 20MB 消息
