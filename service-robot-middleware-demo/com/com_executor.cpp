...
#include "camera/camera_hal_if_node.hpp"
...
int main(int argc, char* argv[])
{
    ...
    auto camera_hal_if_node = rclcpp::make_shared<CameraHalIfNode>(options);
    ...
    auto exec_camera_hal_if = rclcpp::make_shared<rclcpp::executors::SingleThreadedExecutor>();
    ...
    exec_camera_hal_if->add_node(camera_hal_if_node);
    ...
    std::thread camera_hal_if_thread([exec_camera_hal_if]() { exec_camera_hal_if->spin(); });
